...
class MolTestDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        pkl_path = 'bbbp_smiles2text_embeddings.pkl'
        with open(pkl_path, 'rb') as file:  
            smiles2embeddings = pickle.load(file)

        x = torch.tensor(smiles2embeddings[self.smiles_data[index]], dtype=torch.long).view(-1,1)
